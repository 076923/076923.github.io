...
<img data-src="{{ site.images }}/assets/posts/C-Sharp/Dynamixel/lecture-2/1.webp" class="lazyload" width="100%" height="100%"/>
...
<img data-src="{{ site.images }}/assets/posts/C-Sharp/Dynamixel/lecture-2/2.webp" class="lazyload" width="100%" height="100%"/>

프로그램 상단에서 `포트 설정` 후 `포트 연결` 버튼을 누릅니다.

<br>

<img data-src="{{ site.images }}/assets/posts/C-Sharp/Dynamixel/lecture-2/3.webp" class="lazyload" width="100%" height="100%"/>

`DXL 1.0`에 체크합니다. 그 후, `상세 검색`을 선택한 다음 `검색 시작` 버튼을 눌러 `Dynamixel`을 검색합니다.

<br>

<img data-src="{{ site.images }}/assets/posts/C-Sharp/Dynamixel/lecture-2/4.webp" class="lazyload" width="100%" height="100%"/>
...
<img data-src="{{ site.images }}/assets/posts/C-Sharp/Dynamixel/lecture-2/5.webp" class="lazyload" width="100%" height="100%"/>
