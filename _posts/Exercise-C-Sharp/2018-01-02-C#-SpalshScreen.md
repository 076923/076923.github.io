...
<img data-src="{{ site.images }}/assets/posts/Exercise/C-Sharp/C-Sharp/spalshscreen/0.gif" class="lazyload" width="100%" height="100%"/>
...
<img data-src="{{ site.images }}/assets/posts/Exercise/C-Sharp/C-Sharp/spalshscreen/1.webp" class="lazyload" width="100%" height="100%"/>

`프로젝트(P)` → `새 항목 추가(W)`를 눌러 `Splash Screen`이 될 `Form`을 추가합니다.

<br>

<img data-src="{{ site.images }}/assets/posts/Exercise/C-Sharp/C-Sharp/spalshscreen/2.webp" class="lazyload" width="100%" height="100%"/>
...
<img data-src="{{ site.images }}/assets/posts/Exercise/C-Sharp/C-Sharp/spalshscreen/3.webp" class="lazyload" width="100%" height="100%"/>
