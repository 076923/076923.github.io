...
![0]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/0.webp){: width="100%" height="100%"}
...
![1]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/1.webp){: width="100%" height="100%"}

<br>

#### return g

![2]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/2.webp){: width="100%" height="100%"}

<br>

#### return r

![3]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/3.webp){: width="100%" height="100%"}
...
![4]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/4.webp){: width="100%" height="100%"}

<br>

#### merge(g, null, null, null, merge)

![5]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/5.webp){: width="100%" height="100%"}

<br>

#### merge(r, null, null, null, merge)

![6]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/6.webp){: width="100%" height="100%"}

<br>

#### merge(null, b, null, null, merge)

![7]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/7.webp){: width="100%" height="100%"}

<br>

#### merge(null, null, b, null, merge)

![8]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/8.webp){: width="100%" height="100%"}

<br>

#### merge(b, b, b, null, merge)

![9]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-16/9.webp){: width="100%" height="100%"}
