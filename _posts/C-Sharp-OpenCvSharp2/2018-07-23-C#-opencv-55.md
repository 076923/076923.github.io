...
![1]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/1.webp){: width="100%" height="100%"}
...
![2]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/2.webp){: width="100%" height="100%"}
...
![3]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/3.webp){: width="100%" height="100%"}

<br>

### sqsum

![4]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/4.webp){: width="100%" height="100%"}

<br>

### tiltedsum

![5]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/5.webp){: width="100%" height="100%"}
...
![6]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/6.webp){: width="100%" height="100%"}

여기서 `붉은색` 위치의 `I3 값`의 값은 다음 이미지의 `픽셀 합`과 같습니다.

<br>

![7]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/7.webp){: width="100%" height="100%"}
...
![8]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-55/8.webp){: width="100%" height="100%"}
