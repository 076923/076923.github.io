...
![1]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-20/1.webp){:class="lazyload" width="100%" height="100%"}
...
`Storage`는 윤곽선(컨투어)의 `메모리를 저장`합니다.
...
![2]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-20/2.webp){:class="lazyload" width="100%" height="100%"}
