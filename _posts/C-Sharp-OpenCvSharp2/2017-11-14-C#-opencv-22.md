...
![1]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-22/1.webp){: width="100%" height="100%"}
...
![2]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-22/2.webp){: width="100%" height="100%"}

<br>

### ApproxPoly - 근사정확도 = 1

![3]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-22/3.webp){: width="100%" height="100%"}

<br>

### ApproxPoly - 시퀀스결정 = false

![4]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-22/4.webp){: width="100%" height="100%"}

<br>

### if - c.total > 3

![4]({{ site.images }}/assets/posts/C-Sharp/OpenCvSharp2/lecture-22/5.webp){: width="100%" height="100%"}
