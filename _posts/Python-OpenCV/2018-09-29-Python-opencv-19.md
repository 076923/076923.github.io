...
![1]({{ site.images }}/assets/posts/Python/OpenCV/lecture-19/1.webp){:class="lazyload" width="100%" height="100%"}
...
![2]({{ site.images }}/assets/posts/Python/OpenCV/lecture-19/2.webp){:class="lazyload" width="100%" height="100%"}
