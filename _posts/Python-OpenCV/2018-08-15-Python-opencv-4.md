...
![1]({{ site.images }}/assets/posts/Python/OpenCV/lecture-4/1.webp){: width="100%" height="100%"}
...
![2]({{ site.images }}/assets/posts/Python/OpenCV/lecture-4/2.webp){: width="100%" height="100%"}
