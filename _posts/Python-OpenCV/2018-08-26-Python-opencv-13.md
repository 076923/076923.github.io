...
![1]({{ site.images }}/assets/posts/Python/OpenCV/lecture-13/1.webp){:class="lazyload" width="100%" height="100%"}
...
![2]({{ site.images }}/assets/posts/Python/OpenCV/lecture-13/2.webp){:class="lazyload" width="100%" height="100%"}
...
![3]({{ site.images }}/assets/posts/Python/OpenCV/lecture-13/3.webp){:class="lazyload" width="100%" height="100%"}
