...
![1]({{ site.images }}/assets/posts/Python/OpenCV/lecture-28/1.jpg)
...
![2]({{ site.images }}/assets/posts/Python/OpenCV/lecture-28/2.JPG)
...
![3]({{ site.images }}/assets/posts/Python/OpenCV/lecture-28/3.jpg)

<br>

### 점진성 확률적 허프 변환(Progressive Probabilistic Hough Transform)

![4]({{ site.images }}/assets/posts/Python/OpenCV/lecture-28/4.jpg)