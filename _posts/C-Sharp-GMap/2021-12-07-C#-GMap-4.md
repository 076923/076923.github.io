...
![1]({{ site.images }}/assets/posts/C-Sharp/GMap/lecture-4/1.png)

`다각형(Polygon)`란 지도 위에 그려지는 **영역을 의미합니다.**
...
![2]({{ site.images }}/assets/posts/C-Sharp/GMap/lecture-4/2.jpg)

<br>

### 원 그리기

![3]({{ site.images }}/assets/posts/C-Sharp/GMap/lecture-4/3.jpg)
