...
![1]({{ site.images }}/assets/images/Python/opencv/ch27/1.jpg)
...
<h2> $$ gradient = dilate(src) - erode(src) $$ </h2>
...
![2]({{ site.images }}/assets/images/Python/opencv/ch27/2.png)