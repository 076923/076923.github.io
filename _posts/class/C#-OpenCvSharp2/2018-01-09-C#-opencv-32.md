...
![1]({{ site.images }}/assets/images/C/opencv/ch32/1.png)
영상이나 이미지에서 **인접한 화소들을 묶어 하나의 객체로 판단하는 방식**입니다.

즉, 인접한(연결된) 화소끼리 `같은 번호를 부여`합니다. **여러 물체를 구분하기 위해서 사용**합니다. `라벨링` 또는 `레이블링`이라 부릅니다.  
...
![2]({{ site.images }}/assets/images/C/opencv/ch32/2.png)
...
![3]({{ site.images }}/assets/images/C/opencv/ch32/3.png)
...
![4]({{ site.images }}/assets/images/C/opencv/ch32/4.png)
...
## Result ##
----------
![5]({{ site.images }}/assets/images/C/opencv/ch32/5.png)
