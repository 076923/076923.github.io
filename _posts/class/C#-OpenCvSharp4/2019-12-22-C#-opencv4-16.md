...
* Tip : `세그먼트(segment)`란 **서로 다른 두 점을 연결하는 가장 짧은 선**을 뜻합니다.
...
namespace Project
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Cv2.Canny(gray, canny, 127, 255, 3, true);
...
전처리 결과를 저장할 `gray`, `canny`를 선언합니다.
...
연산량을 줄이고 정확성을 높이기 위해 `간단한 전처리(캐니 엣지)`를 적용합니다.
